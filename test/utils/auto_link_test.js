module("wysihtml5.utils.autoLink", {
  ...
  autoLink: function(html) {
    ...
    return wysihtml5.utils.autoLink(container).innerHTML;
  } 
});


test("Basic test", function() {
  ok(wysihtml5.utils.autoLink.URL_REG_EXP, "URL reg exp is revealed to be access globally");
